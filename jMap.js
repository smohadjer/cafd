...
function generateAllSlideLayer(c, a) {
...
function selectionChanged() {
	...
	if (enableAllSlides) {
		...
		allslidesLayers.forEach(function (val) {
			val.setVisible(false);
		});
	}
...
function showAllSlides() {
	...
	if (!allslidesLayers[0]) {
		spinner.spin(document.getElementById('map_size'));

		allslidesLayers[0] = generateAllSlidesLayer();
		map.addLayer(allslidesLayers[0]);
		...
		allslidesLayers[0].setVisible(true);
}
